...
import 'events_admin_copy_model.dart';
export 'events_admin_copy_model.dart';

class EventsAdminCopyWidget extends StatefulWidget {
  const EventsAdminCopyWidget({
    super.key,
  ...
  @override
  State<EventsAdminCopyWidget> createState() => _EventsAdminCopyWidgetState();
}

class _EventsAdminCopyWidgetState extends State<EventsAdminCopyWidget> {
  late EventsAdminCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventsAdminCopyModel());
