...
import 'details_card_model.dart';
export 'details_card_model.dart';
...
class _DetailsCardWidgetState extends State<DetailsCardWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsCardModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'This menu will be updated weekly for your convenience.',
                        style:
